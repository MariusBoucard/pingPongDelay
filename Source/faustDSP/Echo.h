...
Compilation options: -a ../faustMinimal.h -lang cpp -ct 1 -cn Echo -es 1 -mcd 16 -single -ftz 0
------------------------------------------------------------ */
...
class Echo : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a ../faustMinimal.h -lang cpp -ct 1 -cn Echo -es 1 -mcd 16 -single -ftz 0");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("FeedBack", &fHslider0, FAUSTFLOAT(0.4f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(0.1f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			output0[i0] = FAUSTFLOAT(fRec0[(IOTA0 - iSlow3) & 524287]);
			fRec1[IOTA0 & 524287] = float(input1[i0]) + fSlow0 * fRec1[(IOTA0 - iSlow2) & 524287];
			output1[i0] = FAUSTFLOAT(fRec1[(IOTA0 - iSlow3) & 524287]);
			IOTA0 = IOTA0 + 1;
		}
	}
